...
class CBillboardGraphicsPipeline : public CGraphicsPipeline
{
public:
	CBillboardGraphicsPipeline(const IRenderer::SGraphicsPipelineDescription& desc, const std::string& uniqueIdentifier, const SGraphicsPipelineKey key);
